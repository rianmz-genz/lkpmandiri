        ...
        <div className="space-y-5 lg:w-3/12">
          ...
          <div className="space-y-[10px]">
            ...
            <Text
              ...
              textStyle="Description"
            />
            <Text value="+62 264 2185 605" textStyle="Description" />
          </div>
        </div>
        <div className="space-y-5 lg:w-3/12">
          <Text value="Kelas" textStyle="FooterTitle" />
          <div className="space-y-48">
            <TextLink textStyle="Description" href="/class/detail" value="Kelas Aplikasi Perkantoran" />
            <TextLink textStyle="Description" href="/class/detail" value="Kelas Design Grafis" />
            <TextLink textStyle="Description" href="/class/detail" value="Kelas Fotografi" />
            <TextLink textStyle="Description" href="/class/detail" value="Kelas Menjahit" />
          </div>
        </div>
      </div>
    </footer>
