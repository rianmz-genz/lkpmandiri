...
const Faq = () => {
  const Lists: ListType[] = [
    ...
    {
      title:
        "Apakah tersedia program kursus yang diselenggarakan secara online?",
      description:
        "Kursus di LKP Mandiri tidak dipungut biaya, alias gratis. Peserta kursus tidak perlu mengeluarkan uang karena segala fasilitas telah disediakan oleh LKP Mandiri. Selama program kursus peserta akan diberikan fasilitas yang bisa digunakan selama program  kursus seperti alat dan bahan menjahit, kamera, komputer/laptop, dan fasilitas lainnya.",
    },
  ];
