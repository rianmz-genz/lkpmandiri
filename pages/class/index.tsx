...
import ProgramCard, {
  ProgramCards,
} from "../../components/molecules/ProgramCard";
...
const Class = () => {
  const Courses: ProgramCards[] = [
    ...
    },
    {
      ...
      description:
        "Dalam kursus ini, peserta kursus akan membangun keterampilan dan pengetahuan yang diperoleh di kelas desain grafis dasar kami dan meningkatkan keterampilan desain ke tingkat berikutnya.",
      meet: "58 Pertemuan",
      month: "3 Bulan",
      totalMember: "+78",
    },
    ...
    },
    {
      ...
      description:
        "Dalam kursus ini, peserta kursus akan membangun keterampilan dan pengetahuan yang diperoleh di kelas fotografi dasar kami dan meningkatkan keterampilan desain ke tingkat berikutnya.",
      meet: "49 Pertemuan",
      month: "4 Bulan",
      totalMember: "+87",
    },
    {
      ...
      description:
        "Dalam kursus ini, peserta kursus akan membangun keterampilan dan pengetahuan yang diperoleh di kelas fotografi terampil kami dan meningkatkan keterampilan desain ke tingkat berikutnya.",
      meet: "45 Pertemuan",
      month: "4 Bulan",
      totalMember: "+23",
    },
    ...
    },
    {
      ...
      description:
        "Dalam kursus ini, peserta kursus akan membangun keterampilan dan pengetahuan yang diperoleh di kelas apt kantor dasar kami dan meningkatkan keterampilan desain ke tingkat berikutnya.",
      meet: "39 Pertemuan",
      month: "3 Bulan",
      totalMember: "+102",
    },
    {
      ...
      title: "Kursus Apt Kantor (Tingkat Dasar)",
      description:
        "Dalam kursus ini, peserta kursus akan membangun keterampilan dan pengetahuan yang diperoleh di kelas apt kantor terampil kami dan meningkatkan keterampilan desain ke tingkat berikutnya.",
      meet: "32 Pertemuan",
      month: "3 Bulan",
      totalMember: "+45",
    },
